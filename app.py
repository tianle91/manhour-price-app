...
from .calculator import get_income_in_minutes, get_price_in_minutes
...
def index():
    ...
    if request.method == 'POST':
        ...
        price_in_minutes = get_price_in_minutes(
            income_in_minutes=income_in_minutes, price=price)
    ...
    return render_template(
        ...
        price_in_minutes=f'{price_in_minutes:.0f}' if has_price_in_minutes else None,
    )
